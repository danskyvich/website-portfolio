...
export const firstProjectIcons = [
  {
...
export const secondProjectIcons = [
  {
    icon: <TypescriptIcon className="w-full max-w-[51px] h-auto" />,
    link: "https://www.typescriptlang.org",
  },
  ...
  {
    icon: <CSharpIcon className="w-full max-w-[60px] h-auto" />,
    link: "https://dotnet.microsoft.com/en-us/languages/csharp",
  },
  {
    icon: <RedisIcon className="w-full max-w-[51px] h-auto" />,
    link: "https://redis.io/",
  },
  {
    icon: <NextJSIcon className="w-full max-w-[107px] h-auto" />,
  ...
  {
    icon: <NETIcon className="w-full max-w-[48px] h-auto" />,
