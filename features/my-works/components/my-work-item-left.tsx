...
export default function MyWorkItemLeft({image, title, description, techStack, githubButtonLink, isDemoButtonDisabled = true, demoButtonLink, tag1, tag2, tag3, tag4}: MyWorkItemLeftProps) {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-1 xl:grid-cols-[1fr_1fr] w-full border-t border-(--color-line) mt-15">
      {/* left side */}
      <div className="flex bg-(--color-brand-blue-dark) w-full h-fit p-2 justify-center">
        <div className="w-full relative h-103">
          <Image
            src={image}
            alt="alt"
            fill
